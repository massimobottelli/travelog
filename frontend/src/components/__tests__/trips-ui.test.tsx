...
describe("TripsPage", () => {
  ...
  it("shows the MANUALE badge in the list and inline day editing in the detail only for manual trips", async () => {
    ...
    // available only inside the manual trip's detail.
    mockApi();
    render(<TripsPage />);
    ...
    // Close it and open the auto-generated trip: no editing affordances.
