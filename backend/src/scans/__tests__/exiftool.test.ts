...
describe("readExif", () => {
  ...
  it("should find at least one valid photo with GPS coordinates in the test directory", async () => {
  ...
  it("should parse DateTimeOriginal as naive local time string", async () => {
  ...
  it("should handle files without GPS by returning null coordinates", async () => {
