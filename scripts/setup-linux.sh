...
echo "  2. Edit .env with your configuration (set DATABASE_URL, CORS_ORIGIN, GEOAPIFY_API_KEY)"
echo "  3. npm run build             # compile TypeScript + Vite production build"
echo "  4. npm run db:migrate --workspace=@travelog/backend   # apply database migrations"
